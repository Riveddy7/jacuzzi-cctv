...
const ExecutionPlan = () => {
  ...
  const phases = [
    ...
    },
    {
      ...
      icon: CheckCircle2,
      activities: [
        { task: "Installation of 202 Camera Network Nodes, termination and labeling", duration: "3 weeks" }
      ]
    },
    {
      ...
      icon: Clock,
      activities: [
        { task: "Mounting and focusing of 202 cameras indoors and outdoors", duration: "3 weeks" }
      ]
    }
  ];
