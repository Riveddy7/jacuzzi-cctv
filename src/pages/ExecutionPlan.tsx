...
const ExecutionPlan = () => {
  ...
  const phases = [
    ...
    },
    {
      ...
      icon: CheckCircle2,
      activities: [
        { task: "Installation of 175 Camera Network Nodes, termination and labeling", duration: "3 weeks" }
      ]
    },
    {
      ...
      icon: Clock,
      activities: [
        { task: "Mounting and focusing of 175 cameras indoors and outdoors", duration: "3 weeks" }
      ]
    }
  ];
